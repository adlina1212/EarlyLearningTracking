...
@WebServlet("/literacyProgress")
public class literacyProgressServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Literacy studentId: " + studentId);
        ...
        try {
            ...
            if (studentDoc.exists()) {
                ...
                List<String> literacyList = null;
                if (criteriaDoc.exists()) {
                    literacyList = (List<String>) criteriaDoc.get("literacyList");
                }
                ...
                // Forward to JSP
                request.getRequestDispatcher("literacyProgress.jsp").forward(request, response);
            } else {
                response.sendRedirect("error.html");
            }
